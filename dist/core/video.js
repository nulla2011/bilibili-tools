...
let getVideoInfo = (input) => __awaiter(void 0, void 0, void 0, function* () {
...
class Page extends Video {
    ...
    play(videoOn = 1, audioOn = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = yield this.getPlayurl();
            console.log(url);
    ...
    download(path, videoOn = 1, audioOn = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = yield this.getPlayurl();
